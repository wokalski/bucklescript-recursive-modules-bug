...
and View : sig
  val name': unit -> string
  type t = { style: Nars_struct.Google_mirror.Protobuf.Struct.t option; children: ReactElement.t list } 
  val to_proto: t -> Ocaml_protoc_plugin.Writer.t
  val from_proto: Ocaml_protoc_plugin.Reader.t -> t Ocaml_protoc_plugin.Result.t
end = struct 
  ...
  let to_proto = 
    ...
    let spec = Ocaml_protoc_plugin.Serialize.C.( basic_opt (1, (message Nars_struct.Google_mirror.Protobuf.Struct.to_proto)) ^:: repeated (2, (message ReactElement.to_proto), not_packed) ^:: nil ) in
    let serialize = Ocaml_protoc_plugin.Serialize.serialize (spec) in
    fun t -> apply ~f:(serialize ()) t
  
  let from_proto = 
    let constructor = fun style children -> { style; children } in
    let spec = Ocaml_protoc_plugin.Deserialize.C.( basic_opt (1, (message Nars_struct.Google_mirror.Protobuf.Struct.from_proto)) ^:: repeated (2, (message ReactElement.from_proto), not_packed) ^:: nil ) in
    let deserialize = Ocaml_protoc_plugin.Deserialize.deserialize (spec) constructor in
    fun writer -> deserialize writer
...
and FlatList : sig
  val name': unit -> string
  type t = { style: Nars_struct.Google_mirror.Protobuf.Struct.t option; onEndReached: Callback.t option; onEndReachedThreshold: Int32Value.t option; children: ReactElement.t list; localProps: LocalProp.t list } 
  val to_proto: t -> Ocaml_protoc_plugin.Writer.t
  val from_proto: Ocaml_protoc_plugin.Reader.t -> t Ocaml_protoc_plugin.Result.t
end = struct 
  ...
  let to_proto = 
    ...
    let spec = Ocaml_protoc_plugin.Serialize.C.( basic_opt (1, (message Nars_struct.Google_mirror.Protobuf.Struct.to_proto)) ^:: basic_opt (2, (message Callback.to_proto)) ^:: basic_opt (3, (message Int32Value.to_proto)) ^:: repeated (4, (message ReactElement.to_proto), not_packed) ^:: repeated (5, (message LocalProp.to_proto), not_packed) ^:: nil ) in
    let serialize = Ocaml_protoc_plugin.Serialize.serialize (spec) in
    fun t -> apply ~f:(serialize ()) t
  ...
  let from_proto = 
    ...
    let spec = Ocaml_protoc_plugin.Deserialize.C.( basic_opt (1, (message Nars_struct.Google_mirror.Protobuf.Struct.from_proto)) ^:: basic_opt (2, (message Callback.from_proto)) ^:: basic_opt (3, (message Int32Value.from_proto)) ^:: repeated (4, (message ReactElement.from_proto), not_packed) ^:: repeated (5, (message LocalProp.from_proto), not_packed) ^:: nil ) in
    let deserialize = Ocaml_protoc_plugin.Deserialize.deserialize (spec) constructor in
    fun writer -> deserialize writer
...
and TextInput : sig
  val name': unit -> string
  type t = { style: Nars_struct.Google_mirror.Protobuf.Struct.t option; placeholderTextColor: StringValue.t option; placeholder: StringValue.t option; value: string; localProps: LocalProp.t list; onValueChange: Callback.t option } 
  val to_proto: t -> Ocaml_protoc_plugin.Writer.t
  val from_proto: Ocaml_protoc_plugin.Reader.t -> t Ocaml_protoc_plugin.Result.t
end = struct 
  ...
  let to_proto = 
    ...
    let spec = Ocaml_protoc_plugin.Serialize.C.( basic_opt (1, (message Nars_struct.Google_mirror.Protobuf.Struct.to_proto)) ^:: basic_opt (2, (message StringValue.to_proto)) ^:: basic_opt (3, (message StringValue.to_proto)) ^:: basic (4, string, proto3) ^:: repeated (5, (message LocalProp.to_proto), not_packed) ^:: basic_opt (6, (message Callback.to_proto)) ^:: nil ) in
    let serialize = Ocaml_protoc_plugin.Serialize.serialize (spec) in
    fun t -> apply ~f:(serialize ()) t
  ...
  let from_proto = 
    ...
    let spec = Ocaml_protoc_plugin.Deserialize.C.( basic_opt (1, (message Nars_struct.Google_mirror.Protobuf.Struct.from_proto)) ^:: basic_opt (2, (message StringValue.from_proto)) ^:: basic_opt (3, (message StringValue.from_proto)) ^:: basic (4, string, proto3) ^:: repeated (5, (message LocalProp.from_proto), not_packed) ^:: basic_opt (6, (message Callback.from_proto)) ^:: nil ) in
    let deserialize = Ocaml_protoc_plugin.Deserialize.deserialize (spec) constructor in
    fun writer -> deserialize writer
...
and Switch : sig
  val name': unit -> string
  type t = { style: Nars_struct.Google_mirror.Protobuf.Struct.t option; value: bool; onValueChange: Callback.t option } 
  val to_proto: t -> Ocaml_protoc_plugin.Writer.t
  val from_proto: Ocaml_protoc_plugin.Reader.t -> t Ocaml_protoc_plugin.Result.t
end = struct 
  ...
  let to_proto = 
    ...
    let spec = Ocaml_protoc_plugin.Serialize.C.( basic_opt (1, (message Nars_struct.Google_mirror.Protobuf.Struct.to_proto)) ^:: basic (2, bool, proto3) ^:: basic_opt (3, (message Callback.to_proto)) ^:: nil ) in
    let serialize = Ocaml_protoc_plugin.Serialize.serialize (spec) in
    fun t -> apply ~f:(serialize ()) t
  
  let from_proto = 
    let constructor = fun style value onValueChange -> { style; value; onValueChange } in
    let spec = Ocaml_protoc_plugin.Deserialize.C.( basic_opt (1, (message Nars_struct.Google_mirror.Protobuf.Struct.from_proto)) ^:: basic (2, bool, proto3) ^:: basic_opt (3, (message Callback.from_proto)) ^:: nil ) in
    let deserialize = Ocaml_protoc_plugin.Deserialize.deserialize (spec) constructor in
    fun writer -> deserialize writer
...
and Image : sig
  val name': unit -> string
  type t = { style: Nars_struct.Google_mirror.Protobuf.Struct.t option; sourceURLString: string } 
  val to_proto: t -> Ocaml_protoc_plugin.Writer.t
  val from_proto: Ocaml_protoc_plugin.Reader.t -> t Ocaml_protoc_plugin.Result.t
end = struct 
  ...
  let to_proto = 
    ...
    let spec = Ocaml_protoc_plugin.Serialize.C.( basic_opt (1, (message Nars_struct.Google_mirror.Protobuf.Struct.to_proto)) ^:: basic (2, string, proto3) ^:: nil ) in
    let serialize = Ocaml_protoc_plugin.Serialize.serialize (spec) in
    fun t -> apply ~f:(serialize ()) t
  
  let from_proto = 
    let constructor = fun style sourceURLString -> { style; sourceURLString } in
    let spec = Ocaml_protoc_plugin.Deserialize.C.( basic_opt (1, (message Nars_struct.Google_mirror.Protobuf.Struct.from_proto)) ^:: basic (2, string, proto3) ^:: nil ) in
    let deserialize = Ocaml_protoc_plugin.Deserialize.deserialize (spec) constructor in
    fun writer -> deserialize writer
...
and Render : sig
  val name': unit -> string
  type t = { name: string; props: Nars_struct.Google_mirror.Protobuf.Struct.t option; localProps: string list } 
  val to_proto: t -> Ocaml_protoc_plugin.Writer.t
  val from_proto: Ocaml_protoc_plugin.Reader.t -> t Ocaml_protoc_plugin.Result.t
end = struct 
  ...
  let to_proto = 
    ...
    let spec = Ocaml_protoc_plugin.Serialize.C.( basic (1, string, proto3) ^:: basic_opt (2, (message Nars_struct.Google_mirror.Protobuf.Struct.to_proto)) ^:: repeated (3, string, packed) ^:: nil ) in
    let serialize = Ocaml_protoc_plugin.Serialize.serialize (spec) in
    fun t -> apply ~f:(serialize ()) t
  
  let from_proto = 
    let constructor = fun name props localProps -> { name; props; localProps } in
    let spec = Ocaml_protoc_plugin.Deserialize.C.( basic (1, string, proto3) ^:: basic_opt (2, (message Nars_struct.Google_mirror.Protobuf.Struct.from_proto)) ^:: repeated (3, string, packed) ^:: nil ) in
    let deserialize = Ocaml_protoc_plugin.Deserialize.deserialize (spec) constructor in
    fun writer -> deserialize writer
...
and Call : sig
  val name': unit -> string
  type t = { messageId: int; args: Nars_struct.Google_mirror.Protobuf.Struct.t option } 
  val to_proto: t -> Ocaml_protoc_plugin.Writer.t
  val from_proto: Ocaml_protoc_plugin.Reader.t -> t Ocaml_protoc_plugin.Result.t
end = struct 
  ...
  let to_proto = 
    ...
    let spec = Ocaml_protoc_plugin.Serialize.C.( basic (1, int32_int, proto3) ^:: basic_opt (2, (message Nars_struct.Google_mirror.Protobuf.Struct.to_proto)) ^:: nil ) in
    let serialize = Ocaml_protoc_plugin.Serialize.serialize (spec) in
    fun t -> apply ~f:(serialize ()) t
  
  let from_proto = 
    let constructor = fun messageId args -> { messageId; args } in
    let spec = Ocaml_protoc_plugin.Deserialize.C.( basic (1, int32_int, proto3) ^:: basic_opt (2, (message Nars_struct.Google_mirror.Protobuf.Struct.from_proto)) ^:: nil ) in
    let deserialize = Ocaml_protoc_plugin.Deserialize.deserialize (spec) constructor in
    fun writer -> deserialize writer
