  ...
  module Protobuf = struct
    ...
    and Struct : sig
      ...
      module rec FieldsEntry : sig
        ...
        let name' () = "Nars_struct.google_mirror.protobuf.Struct.FieldsEntry"
        type t = (string * Value.t option) 
        let to_proto = 
      ...
      let name' () = "Nars_struct.google_mirror.protobuf.Struct"
      type t = FieldsEntry.t list 
      let to_proto = 
    ...
    and Value : sig
      ...
      let name' () = "Nars_struct.google_mirror.protobuf.Value"
      type t = [ `Null_value of NullValue.t | `Number_value of float | `String_value of string | `Bool_value of bool | `Struct_value of Struct.t | `List_value of ListValue.t ] 
      let to_proto = 
        let apply = fun ~f a -> f a in
    ...
    and ListValue : sig
      ...
      let name' () = "Nars_struct.google_mirror.protobuf.ListValue"
      type t = Value.t list 
      let to_proto = 
        let apply = fun ~f a -> f a in
